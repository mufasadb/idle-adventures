...
// --- D60: weapon-enhancement recipes (still oils + anvil whetstone) ----------

test("weapon-enhancement: still oils reject missing-station, then craft once the still is built (D60)", () => {
...
test("weapon-enhancement: whetstone is anvil+hammer gated (D60)", () => {
...
test("weapon-enhancement: the still recipe builds the still station (D60)", () => {
