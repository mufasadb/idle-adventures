...
import { WEAPONS, ARMOUR, TOOL_CAPABILITY, TRANSPORT_MULTIPLIER, BACKPACK_SLOTS, FOOD, POTION, BATTLE_ITEM, PANNIERS, AMMO, ENHANCEMENT } from "../data/constants";
...
export function slotOf(defId: string): LoadoutSlot | null {
  ...
  if (ENHANCEMENT.includes(defId)) return "enhancement"; // weapon enhancements (D59)
  return null;
}
