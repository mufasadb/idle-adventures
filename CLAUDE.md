...
**YOU ARE IN: `idle_adventures/polecats/molly/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/molly
```
...
**Your mail address:** `idle_adventures/polecats/molly`
...
1. Announce: "Polecat molly, checking in."
