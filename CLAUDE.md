...
**YOU ARE IN: `idle_adventures/polecats/harry/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/harry
```
...
**Your mail address:** `idle_adventures/polecats/harry`
...
1. Announce: "Polecat harry, checking in."
