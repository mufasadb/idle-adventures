...
**YOU ARE IN: `idle_adventures/polecats/murphy/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/idle_adventures/` (rig root) or other directories

```bash
pwd  # Should show .../polecats/murphy
```
...
**Your mail address:** `idle_adventures/polecats/murphy`
**Your rig:** idle_adventures
**Your Witness:** `idle_adventures/witness`
...
1. Announce: "Polecat murphy, checking in."
...
| Ask Witness for help | `gt mail send idle_adventures/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`idle_adventures/witness`) when:
...
```bash
gt mail send idle_adventures/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
